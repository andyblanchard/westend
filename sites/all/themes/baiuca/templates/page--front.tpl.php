...
//Get the Quotes image
$quotes_image = theme_get_setting('background_quote');

if(isset($quotes_image)){

    $file_bg_quotes_image = file_load($quotes_image);

    if(isset($file_bg_quotes_image->uri)){
        $quotes_image_url = file_create_url($file_bg_quotes_image->uri);
    }

}


//Get the Social image
$social_image = theme_get_setting('background_social');
if(isset($social_image)){

    $file_bg_social_image = file_load($social_image);

    if(isset($file_bg_social_image->uri)){
        $social_image_url = file_create_url($file_bg_social_image->uri);
    }
}
...
<?php if (isset($quotes_image_url)): ?>
    <style>
        .quote_region{
            background: url("<?php print $quotes_image_url; ?>") 0px fixed;
        }
    </style>
<?php endif; ?>

<?php if (isset($social_image_url)): ?>
    <style>
        .social_region{
            background: url("<?php print $social_image_url; ?>") 0px fixed;
        }
    </style>
<?php endif; ?>
...
//                print render($page['navigation']);
    ...
    <div id="wrapper_overall" class="<?php print $layout_type; ?>">
        ...
        <?php if (!empty($page['social_area'])): ?>
            <div class="social_region">
                <div class="overlay"></div>
                <div class="container">
                    <?php print render($page['social_area']); ?>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="contact_area">
            ...
            <div class="contact_map">
                ...
                <a type="button" class="btn btn-default contact_vieform_button">
                    <span class="glyphicon glyphicon-envelope"></span> View form
                </a>
            ...
            <div class="container contact_form">
                ...
                <a type="button" class="btn btn-default contact_viewmap_button">
                    <span class="glyphicon glyphicon-map-marker"></span> View map
                </a>


                <div style="text-align:center;">
                    <i class="fa fa-2x fa-envelope theme_color">
                        <!-- icon --></i><p>
                    </p>
                    <div class="cross-title">
                        <h4><span>Make your reservation</span></h4>
                    </div>
                </div>
