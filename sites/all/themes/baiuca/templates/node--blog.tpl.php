...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    ...
    <div class="blog_content">
        ...
        <div class="blog_head">
            <?php if (isset($content['field_image']['#object']->field_image[$node->language])): ?>
                    ...
                    <div class="post-thumbnail slider-thumbnail" data-effect="slide">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                $image_fields = $content['field_image']['#object']->field_image[$node->language];
                                ...
                                foreach($image_fields as $key => $image){
                                    ...
                                    print theme('image_style', array('style_name' => 'blog_detail', 'path' => $image['uri'], 'attributes' => array('class' => '')));
